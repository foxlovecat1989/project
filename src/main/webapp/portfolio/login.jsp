...
<html>
            ...
            $(document).ready(function () {
                $("#add").on("click", function () {
                    ...
                    $.ajax({
                        ...
                        processData: false, 
                        // processData: true時,
                        // 當傳送至 Server 的資料，會自動轉為 query string 的型式，
                        // 如果是 GET 請求還會幫你附加到 URL。
                        // 可用 processData : false 選項禁止此自動轉換。
                        // JSON 格式 才不會被轉換
    ...
    <center>
        <table bgcolor="#FFFFFF">
            <td valign="top">
                <form class="pure-form" method="post" action="${pageContext.request.contextPath}/app/portfolio/login">
                    <fieldset>
            ...
            <td valign="top">
                <form id="regform" class="pure-form" method="post" action="${pageContext.request.contextPath}/app/portfolio/login">
                    <fieldset>
