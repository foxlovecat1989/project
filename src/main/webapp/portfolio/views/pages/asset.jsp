...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><b>Asset</b></h1>
...
//                        }
    ...
    function table_list(datas) {
        ...
        $.each(datas, function (i, item) {
            ...
            sellbtn_html = '<button type="button" class="btn btn-outline btn-warning">賣出</button>';
            buylbtn_html = '<button type="button" class="btn btn-outline btn-primary">加碼</button>';
